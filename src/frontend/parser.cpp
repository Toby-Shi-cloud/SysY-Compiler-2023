...
pGrammarNode SysYParser::parse_impl<CompUnit>() {
    ...
    if (current != tokens.end()) throw(dbg(*result, *current), std::runtime_error("Error while parsing CompUnit"));
    return result;
}
...
pGrammarNode SysYParser::parse_impl<ConstDecl>() {
    auto gen = generator<CONSTTK>() + generator<BType>() + generator<ConstDef>() +
               (generator<COMMA>() + generator<ConstDef>()) * MANY + generator<SEMICN>('i');
...
pGrammarNode SysYParser::parse_impl<ConstInitVal>() {
    auto gen = generator<ConstExp>() | generator<LBRACE>() + generator<RBRACE>() |
               generator<LBRACE>() + generator<ConstInitVal>() +
                   (generator<COMMA>() + generator<ConstInitVal>()) * MANY + generator<RBRACE>();
    return grammarNode(ConstInitVal, gen);
}

template <>
pGrammarNode SysYParser::parse_impl<VarDecl>() {
    auto gen = generator<BType>() + generator<VarDef>() + (generator<COMMA>() + generator<VarDef>()) * MANY +
               generator<SEMICN>('i');
...
pGrammarNode SysYParser::parse_impl<InitVal>() {
    auto gen = generator<Exp>() | generator<LBRACE>() + generator<RBRACE>() |
               generator<LBRACE>() + generator<InitVal>() + (generator<COMMA>() + generator<InitVal>()) * MANY +
                   generator<RBRACE>();
...
pGrammarNode SysYParser::parse_impl<FuncDef>() {
    auto gen = generator<FuncType>() + generator<IDENFR>() + generator<LPARENT>() + generator<FuncFParams>() * OPTION +
...
pGrammarNode SysYParser::parse_impl<FuncFParam>() {
    auto gen = generator<BType>() + generator<IDENFR>() +
               (generator<LBRACK>() + generator<RBRACK>('k') +
                (generator<LBRACK>() + generator<ConstExp>() + generator<RBRACK>('k')) * MANY) *
                   OPTION;
...
pGrammarNode SysYParser::parse_impl<Stmt>() {
    auto gen = generator<AssignStmt>() | generator<BlockStmt>() | generator<IfStmt>() | generator<WhileStmt>() |
               generator<ForLoopStmt>() | generator<BreakStmt>() | generator<ContinueStmt>() | generator<ReturnStmt>() |
               generator<ExpStmt>();
...
pGrammarNode SysYParser::parse_impl<WhileStmt>() {
    auto gen =
        generator<WHILETK>() + generator<LPARENT>() + generator<Cond>() + generator<RPARENT>() + generator<Stmt>();
...
pGrammarNode SysYParser::parse_impl<PrimaryExp>() {
    auto gen =
        generator<LPARENT>() + generator<Exp>() + generator<RPARENT>('j') | generator<LVal>() | generator<Number>();
...
pGrammarNode SysYParser::parse_impl<UnaryExp>() {
    auto gen =
        generator<IDENFR>() + generator<LPARENT>() + generator<FuncRParams>() * OPTION + generator<RPARENT>('j') |
        generator<PrimaryExp>() | generator<UnaryOp>() + generator<UnaryExp>();
...
pGrammarNode SysYParser::parse_impl<AddExp>() {
    auto gen = generator<MulExp>() + ((generator<PLUS>() | generator<MINU>()) + generator<MulExp>()) * MANY;
...
pGrammarNode SysYParser::parse_impl<RelExp>() {
    auto gen =
        generator<AddExp>() +
        ((generator<LSS>() | generator<LEQ>() | generator<GRE>() | generator<GEQ>()) + generator<AddExp>()) * MANY;
    return grammarNode(RelExp, gen);
}

template <>
pGrammarNode SysYParser::parse_impl<EqExp>() {
    auto gen = generator<RelExp>() + ((generator<EQL>() | generator<NEQ>()) + generator<RelExp>()) * MANY;
...
pTerminalNode SysYParser::need_terminal(lexer::token_type_t type, int error_code) {
    if (current->type == type) return std::make_unique<TerminalNode>(*current++);
    if (error_code) {
        using namespace std::string_literals;
        auto last_token = current - 1;
        auto line = last_token->line;
        auto column = last_token->column + last_token->raw.size();
        message_queue.push_back({message::ERROR, error_code, line, column, "missing token '"s + raw[type] + "'"});
...
generator_t operator*(const generator_t &gen, _option) {
    return [gen](SysYParser *self) -> optGrammarNodeList {
        if (auto result = gen(self)) return result;
