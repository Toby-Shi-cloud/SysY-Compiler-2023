...
Function *Function::getarray() {
    const static Function _f(FunctionType::getFunctionType(
                                 Type::getI32Type(), {Type::getPointerType(Type::getI32Type())}),
                             "getarray");
    return const_cast<Function *>(&_f);
}
...
Function *Function::getfarray() {
    const static Function _f(FunctionType::getFunctionType(
                                 Type::getI32Type(), {Type::getPointerType(Type::getFloatType())}),
                             "getfarray");
    return const_cast<Function *>(&_f);
}
...
Function *Function::starttime() {
    const static Function _f(
        FunctionType::getFunctionType(Type::getVoidType(), {Type::getI32Type()}),
        "_sysy_starttime");
    return const_cast<Function *>(&_f);
}
...
Function *Function::stoptime() {
    const static Function _f(
        FunctionType::getFunctionType(Type::getVoidType(), {Type::getI32Type()}), "_sysy_stoptime");
    return const_cast<Function *>(&_f);
}
}  // namespace mir
...
ArrayLiteral::ArrayLiteral(std::vector<Literal *> values)
    : Literal(ArrayType::getArrayType((int)values.size(),
