...
pGrammarNode SysYParser::parse_impl<VarDecl>() {
    auto gen = generator<BType>() + generator<VarDef>() +
               (generator<COMMA>() + generator<VarDef>()) * MANY + generator<SEMICN>('i');
...
pGrammarNode SysYParser::parse_impl<InitVal>() {
    auto gen = generator<Exp>() | generator<LBRACE>() + generator<RBRACE>() |
               generator<LBRACE>() + generator<InitVal>() +
                   (generator<COMMA>() + generator<InitVal>()) * MANY + generator<RBRACE>();
...
pGrammarNode SysYParser::parse_impl<IfStmt>() {
    auto gen = generator<IFTK>() + generator<LPARENT>() + generator<Cond>() +
               generator<RPARENT>('j') + generator<Stmt>() +
               (generator<ELSETK>() + generator<Stmt>()) * OPTION;
    return grammarNode(IfStmt, gen);
}

template <>
pGrammarNode SysYParser::parse_impl<WhileStmt>() {
    auto gen = generator<WHILETK>() + generator<LPARENT>() + generator<Cond>() +
...
pGrammarNode SysYParser::parse_impl<ForLoopStmt>() {
    auto gen = generator<FORTK>() + generator<LPARENT>() + generator<ForStmt>() * OPTION +
               generator<SEMICN>() + generator<Cond>() * OPTION + generator<SEMICN>() +
               generator<ForStmt>() * OPTION + generator<RPARENT>('j') + generator<Stmt>();
...
pGrammarNode SysYParser::parse_impl<LVal>() {
    auto gen = generator<IDENFR>() +
               (generator<LBRACK>() + generator<Exp>() + generator<RBRACK>('k')) * MANY;
...
pGrammarNode SysYParser::parse_impl<RelExp>() {
    auto gen = generator<AddExp>() +
               ((generator<LSS>() | generator<LEQ>() | generator<GRE>() | generator<GEQ>()) +
                generator<AddExp>()) *
                   MANY;
...
pGrammarNode SysYParser::parse_impl<EqExp>() {
    auto gen =
        generator<RelExp>() + ((generator<EQL>() | generator<NEQ>()) + generator<RelExp>()) * MANY;
...
pTerminalNode SysYParser::need_terminal(lexer::token_type_t type, int error_code) {
    ...
    if (error_code) {
        ...
        message_queue.push_back(
            {message::ERROR, error_code, line, column, "missing token '"s + raw[type] + "'"});
